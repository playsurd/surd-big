(function() {
  ...
  function ensureLoadingUI() {
    if (uiInitialized || !document.body) return;
  ...
  // Set up fetch interception immediately (before DOM is ready)
  ...
  // Wait for DOM before starting merge process
  function init() {
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', autoMergeFiles);
    } else {
      // DOM already loaded
      autoMergeFiles();
    }
